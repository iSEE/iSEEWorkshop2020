...
<!-- |                    |                                                                     |                                        | -->
<!-- |--------------------|:-------------------------------------------------------------------:|----------------------------------------| -->
<!-- | Organization | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "PanelOrganization.png"), dpi = 180)` | [Organize panels](#configuration-ui), [Examine panel chart](#transmit-point-selections) | -->
<!-- | Export        | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Export.png"), dpi = 180)`       | [Download panel output](#download-output), [Extract R code](#reproducibility), [Display panel settings](#configuration-ui) | -->
<!-- | Documentation      | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Documentation.png"), dpi = 180)`     | [Quick tour](#sharing-tours), [Open the vignette](#more-resources) | -->
<!-- | Additional info    | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "AdditionalInfo.png"), dpi = 180)`    | [About this session](#reproducibility), [About iSEE](#more-resources) | -->

|                    |                                                                     |                                        |
|--------------------|:-------------------------------------------------------------------:|----------------------------------------|
| Organization | `r knitr::include_graphics("controls/PanelOrganization.png", dpi = 180)` | [Organize panels](#configuration-ui), [Examine panel chart](#transmit-point-selections) |
| Export        | `r knitr::include_graphics("controls/Export.png", dpi = 180)`       | [Download panel output](#download-output), [Extract R code](#reproducibility), [Display panel settings](#configuration-ui) |
| Documentation      | `r knitr::include_graphics("controls/Documentation.png", dpi = 180)`     | [Quick tour](#sharing-tours), [Open the vignette](#more-resources) |
| Additional info    | `r knitr::include_graphics("controls/AdditionalInfo.png", dpi = 180)`    | [About this session](#reproducibility), [About iSEE](#more-resources) |
