...
var.stats <- scran::modelGeneVar(sce)
set.seed(1000)
sce <- scran::denoisePCA(sce, technical=var.stats)
...
|                    |                                                                     |                                        |
|--------------------|:-------------------------------------------------------------------:|----------------------------------------|
| Panel organization | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "PanelOrganization.png"))` | [Organize panels](#configuration-ui) |
| Diagnostics        | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Diagnostics.png"))`       | [Examine panel chart](#transmit-point-selections), [Extract R code](#reproducibility), [Display panel settings](#configuration-ui) |
...
redDimArgs[1, "ColorByColData"] <- "log10_total"
...
colDataArgs[1, "YAxis"] <- "subsets_MT_percent"
colDataArgs$XAxis <- "Column data"
colDataArgs[1, "XAxisColData"] <- "Cluster"
rowDataArgs <- rowDataPlotDefaults(sce, 1)
rowDataArgs[1, "YAxis"] <- "n_cells"
rowDataArgs$XAxis <- "Row data"
rowDataArgs[1, "XAxisRowData"] <- "log10_total"
initialPanels <- DataFrame(
...
featAssayArgs[2, "XAxisColData"] <- "log10_total"
...
colDataArgs[1, "YAxis"] <- "log10_total"
colDataArgs[1, "XAxis"] <- "Column data"
colDataArgs[1, "XAxisColData"] <- "subsets_MT_percent"
...
colStatArgs[["Selected"]] <- match("Cell384", colnames(sce1))
initialPanels <- DataFrame(
