...
#### Column data table {#colstattable}
...
|                    |                                                                     |                                        |
|--------------------|:-------------------------------------------------------------------:|----------------------------------------|
| Organization | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "PanelOrganization.png"))` | [Organize panels](#configuration-ui) |
| Export        | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Diagnostics.png"))`       | [Examine panel chart](#transmit-point-selections), [Extract R code](#reproducibility), [Display panel settings](#configuration-ui) |
...
```{r}
initial <- list(ReducedDimensionPlot(PanelWidth = 3L, PanelHeight = 460L), 
                ColumnDataPlot(PanelWidth = 3L, PanelHeight = 460L),
                RowDataPlot(PanelWidth = 3L, PanelHeight = 460L), 
                ComplexHeatmapPlot(PanelWidth = 3L, PanelHeight = 460L),
                FeatureAssayPlot(PanelWidth = 3L, PanelHeight = 460L),
                SampleAssayPlot(PanelWidth = 3L, PanelHeight = 460L),
                RowDataTable(PanelWidth = 3L, PanelHeight = 460L),
                ColumnDataTable(PanelWidth = 3L, PanelHeight = 460L))
```
