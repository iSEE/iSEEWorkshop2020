...
## Instructor and contributos names and contact information

* Kevin Rue-Albrecht^[University of Oxford, Oxford, UK] (<kevin.rue-albrecht@kennedy.ox.ac.uk>)
...
rowData(sce)$log10_total <- log10(rowSums(assay(sce, "counts")))
sce
```
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "iSEEinterface.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "redDimPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "colDataPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "rowDataPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "heatMap.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "featAssayPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "sampAssayPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "rowStatTable.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "colStatTable.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "colDataPlotDataParams.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "colDataPlotVisualParams.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "redDimPlotSelectionParams.png"))`
...
|                    |                                                                     |                                        |
|--------------------|:-------------------------------------------------------------------:|----------------------------------------|
| Organization | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "PanelOrganization.png"))` | [Organize panels](#configuration-ui), [Examine panel chart](#transmit-point-selections) |
| Export        | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Export.png"))`       | [Download panel output](#download-output), [Extract R code](#reproducibility), [Display panel settings](#configuration-ui) |
| Documentation      | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Documentation.png"))`     | [Quick tour](#sharing-tours), [Open the vignette](#more-resources) |
| Additional info    | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "additionalInfo.png"))`    | [About this session](#reproducibility), [About iSEE](#more-resources) |
...
As a first example, let's assume that we would like to star `iSEE` with the default set of eight panels, but we want each panel to have width equal to 3 rather than the default 4, so that we can fit all the panels in two rows.
...
```{r}
initial <- list(
  ReducedDimensionPlot(Type = "PCA", PanelWidth = 4L, PanelHeight = 400L),
  ReducedDimensionPlot(Type = "TSNE", PanelWidth = 4L, PanelHeight = 400L)
)
if (interactive()) {
    iSEE(sce, initial = initial)
}
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "ReducedDimensionType.png"))`
...
```{r}
initial <- list(
  ReducedDimensionPlot(Type = "PCA", ColorBy = "Column data", ColorByColumnData = "log10_total"),
  ReducedDimensionPlot(Type = "TSNE", ColorBy = "Column data", ColorByColumnData = "Cluster")
)
if (interactive()) {
    iSEE(sce, initial = initial)
}
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "ColorByColData.png"))`
...
initial <- list(
  ReducedDimensionPlot(Type = "TSNE", ColorBy = "Column data", ColorByColumnData = "Cluster"),
  ReducedDimensionPlot(Type = "TSNE", ColorBy = "Feature name", ColorByFeatureName = "CD79A",
                       ColorByFeatureNameAssay = "logcounts"),
  ReducedDimensionPlot(Type = "TSNE", ColorBy = "Feature name", ColorByFeatureName = "CD74",
                       ColorByFeatureNameAssay = "logcounts")
)
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "ColorByFeature.png"))`

<!-- ![](img/ColorByFeature.png) -->

> <i class="fa fa-wrench fa-2x"></i> **Action:** click on the download icon (<i class="fa fa-wrench"></i>) in the top-right corner, and select 'Display panel settings'.
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "ColorBySample.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "ConfigureVisualParameters.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "ConfigureDataPlotPanels.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "featAssayPlotDataParams.png"))`
...
initial <- list(
  ...
  ReducedDimensionPlot(ColumnSelectionSource = "Feature assay plot 1",
                       Type = "TSNE", ColorBy = "Column data",
                       ColorByColumnData = "Cluster", SelectionBoxOpen = TRUE),
  ColumnDataPlot(ColumnSelectionSource = "Feature assay plot 1", SelectionEffect = "Color",
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "LinkingPanelsExample.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "GraphSelectionLinks.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "Zoom.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "FilteredTable.png"))`
...
initial <- list(
  ...
  ReducedDimensionPlot(Type = "TSNE", VisualBoxOpen = TRUE,
                       ColorBy = "Sample name", 
                       ColorBySampleSource = "Column data table 1")
)
if (interactive()) {
    iSEE(sce1, initial = initial)
}
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "LinkTableToPlot.png"))`
...
CUSTOM_PCA <- function(se, rows, columns,
    ...
    kept <- runPCA(kept, subset_row = rows, scale = scale_features)
    plotPCA(kept, colour_by = colour_by)
}
```

> <i class="fa fa-wrench fa-2x"></i> **Action:** Next, launch an iSEE session with the custom PCA plot panel, as well as a _Reduced dimension plot_ panel and a _Row data plot_ panel, from which the column and row selections for the custom PCA are obtained. 
Select subsets of the points in each of these two panels and note how the PCA plot in the custom panel is updated. 
Then, in the _Data parameters box_ in the custom panel, use the 'Custom arguments' field to select another annotation (or a feature name) to color the points by. 
...
# rowDataArgs$YAxis <- "detected"
# rowDataArgs$XAxis <- "Row data"
# rowDataArgs$XAxisRowData <- "log10_total"
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "customPCA.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop2020", "vignettes/img"), "customMultipleDifferentialExpression.png"))`
...
if (interactive()) {
    iSEE(sce, initial = initial, tour = tour)
}
```
